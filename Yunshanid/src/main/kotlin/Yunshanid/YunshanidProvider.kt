        ...
        val type =
            when {
                ...
                typeLabel.contains("tv")
                        || typeLabel.contains("series") -> {
                    TvType.TvSeries
                }

                typeLabel.contains("anime")
                        || typeLabel.contains("donghua") -> {
                    TvType.Anime
                }
