...
object LicenseClient {
        ...
        return try {
            ...
            if (json?.status == "ok" && json.selectors != null) {
                ...
                val cfg = SelectorConfig(
                    playerSelector = raw.serverSelector?.takeIf { it.isNotBlank() } ?: ".mobius > .mirror > option",
    ...
    data class SelectorConfig(val playerSelector: String = ".mobius > .mirror > option", val playerAttr: String = "value", val useBase64: Boolean = true)
